 ...
 * The {@link com.bravos.recruitment.libs.starter.configuration.security.filter.SecurityFilter}
 * validates the {@code X-Internal-Secret} header for such endpoints.
 * </p>
 *
 * @see SecurityAspect
 * @see AuthContext#internal()
 * @see com.bravos.recruitment.libs.starter.configuration.security.filter.SecurityFilter
 */
